...
class TextClass {
    public var intro: [String] = ["Hello, is there anyone here who can help me?",
                                  ...
                                  "Great! For that, we need to memorize some sequences that will be played, and then repeat them exactly the same to score many points ",
                                  
                                  "Oh, and if you don't have a good memory like me, don't worry, we can play with free mode."]
    
    public var aboutMe: String = """
I am Gustavo, I am 24 years old, and I am part of the Apple Developer Academy team in Brazil, at Senac in São Paulo. In my free time, I enjoy studying and learning new things, as well as exercising my body with physical activities such as skateboarding, weightlifting, and swimming.
